...
<head>
    ...
    <title>Agenda Online - Conta criada com sucesso!</title>
    ...
    <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            fill="currentColor"/>
                ...
                <!-- /Logo -->
                <h4 class="mb-1">Conta criada com sucesso!</h4>
                <p class="text-start mb-0">Foi enviado um link de activação da sua conta para o seu email.</p>
                <a class="btn btn-primary w-100 my-6" href="/"> Voltar para o website </a>
            </div>
        </div>
    </div>
</div>
