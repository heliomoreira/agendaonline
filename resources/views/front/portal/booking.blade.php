    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto align-items-center gap-3">
                ...
                <li class="nav-item">
                    <a class="btn btn-primary btn-sm px-3" href="/{{ $portal->slug ?? '' }}/agendamento"
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="mobileNav">
    ...
    <div class="offcanvas-body">
        <nav class="nav flex-column gap-1">
            ...
            <a class="nav-link px-3 py-2 rounded text-primary fw-semibold"
               href="/{{ $portal->slug ?? '' }}/agendamento">
                                ...
                                <div class="service-card"
                                    ...
                                    <div class="service-card-image">
                                        @if(isset($svc->image) && $svc->image)
                                            <img src="{{ global_asset('storage/' . $svc->image) }}"
                                                 alt="{{ $svc->name }}">
                                        @else
                                    ...
                                    <div class="service-card-body">
                                        ...
                                        <div class="service-card-footer">
                                            @if(isset($svc->price))
                                                <div
                                                    class="service-card-price">{{ number_format($svc->price, 2, ',', '.') }}
                                                    €
                                                </div>
                                            @endif
                        ...
                        <div class="col-lg-8">
                            ...
                            <div id="wizProList">
                                <div class="d-flex align-items-center gap-2 py-4 text-muted">
                                    <div class="wiz-spin wiz-spin-dk"></div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="border rounded-3 p-3 mb-3">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <button class="wiz-cal-nb" id="wizPrev" disabled><i
                                            class="ri-arrow-left-s-line"></i></button>
                                    <span class="fw-bold text-capitalize" id="wizCalLbl"></span>
                                    <button class="wiz-cal-nb" id="wizNext"><i class="ri-arrow-right-s-line"></i>
                                    </button>
                                </div>
                                ...
                                <div class="d-flex flex-wrap gap-3 mt-3 pt-2 border-top"
                                     style="font-size:.67rem;color:#6b7280">
                        ...
                        <div class="col-lg-8">
                            ...
                            <form id="wizForm" action="{{ route('book.slot', ['admin' => false]) }}" method="POST">
                                ...
                                <div class="wiz-actions">
                                    ...
                                    @if($requiresPayment ?? false)
                                        <button type="button" class="btn btn-primary px-4" id="wizBtn4"
                                                onclick="wizGoPayment()">
                    ...
                    <div class="wiz-panel" id="wizP5">
                        <div class="row g-4">
                            <div class="col-lg-8">
                                ...
                                <p class="text-muted small mb-4">Introduza os dados do cartão para confirmar a
                                    marcação.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex gap-2 flex-wrap mb-4">
                        @if($portal->instagram ?? null)
                            <a href="{{ $portal->instagram }}" target="_blank" class="btn btn-outline-light btn-sm"><i
                                    class="ri-instagram-line"></i></a>
                        @endif
                        @if($portal->facebook ?? null)
                            <a href="{{ $portal->facebook }}" target="_blank" class="btn btn-outline-light btn-sm"><i
                                    class="ri-facebook-line"></i></a>
                        @endif
                        @if($portal->whatsapp ?? null)
                            <a href="https://wa.me/{{ preg_replace('/\D/', '', $portal->whatsapp) }}" target="_blank"
                               class="btn btn-outline-success btn-sm"><i class="ri-whatsapp-line"></i></a>
                        @endif
                    </div>
                    <a href="/{{ $portal->slug ?? '' }}/agendamento" class="btn btn-primary w-100"
...
<script>
    if (typeof grecaptcha === 'undefined') {
        ...
        window.grecaptcha = {
            ...
            execute: function () {
                return Promise.resolve('no-recaptcha-token');
            }
        };
    }
</script>
