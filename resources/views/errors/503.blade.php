...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{global_global_asset('theme/assets/img/favicon/favicon.ico')}}" />
...
<div class="container-xxl container-p-y py-4">
    <div class="misc-wrapper">
      ...
      {{--  <form onsubmit="return false">
        ...
        <div class="mt-12">
            <img
                src="{{global_asset('theme/assets/img/illustrations/page-misc-launching-soon.png')}}"
