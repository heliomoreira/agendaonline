<!doctype html>
<html lang="pt" class="layout-wide customizer-hide" dir="ltr"
      data-skin="default"
...
<head>
    ...
    <title>Nova Password | Agenda Online</title>
    ...
    <div class="authentication-inner py-6">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mb-1">Nova Password 🔑</h4>
                <p class="mb-6 text-muted">Defina a sua nova password abaixo.</p>
                ...
                <form method="POST" action="{{ route('admin.password.reset.update') }}" novalidate>
                    @csrf
                    ...
                    {{-- Confirmação --}}
                    <div class="mb-6">
                        <label class="form-label" for="password_confirmation">Confirmar Nova Password</label>
                        <div class="input-group input-group-merge">
                            <input
                                type="password"
