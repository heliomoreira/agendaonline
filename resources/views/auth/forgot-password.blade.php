...
<head>
    ...
    <title>Recuperar Password | Agenda Online</title>
    ...
    <div class="authentication-inner py-6">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mb-1">Esqueceu a password? 🔒</h4>
                <p class="mb-6 text-muted">Introduza o seu email e enviaremos um link para repor a sua password.</p>
                ...
                <form method="POST" action="{{ route('admin.password.forgot.send') }}" novalidate>
                    @csrf
