    ...
    <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-xl-flex col-xl-8 p-0">
            <div class="auth-cover-bg d-flex justify-content-center align-items-center">
                <img
                        src="{{global_asset('theme/assets/img/illustrations/auth-login-illustration-light.png')}}"
...
<!-- Vendors JS -->
<script src="{{global_asset('theme/assets/vendor/libs/@form-validation/popular.js')}}"></script>
<script src="{{global_asset('theme/assets/vendor/libs/@form-validation/bootstrap5.js')}}"></script>
<script src="{{global_asset('theme/assets/vendor/libs/@form-validation/auto-focus.js')}}"></script>
